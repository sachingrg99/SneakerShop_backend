...
export const sendEmail = async (email, subject, text) => {
    try {
        ...
        await transporter.sendMail({
            ...
            ">
                    <div>
                        <div variant="h6" style="text-align: center; letter-spacing: 2px; margin: 10px auto;">Welcome to MWH Hotel Management System
                        </div>
...
export const paymentEmail = async (email, subject, text) => {
	try {
		...
		await transporter.sendMail({
			...
			">
			<div>
			<div variant="h6" style="text-align: center; letter-spacing: 2px; margin: 10px auto;">Greeding, Mr.Lalit sir
			</div>
...
export const paymentSuccessByUser = async (email, subject, text) => {
	try {
		...
		await transporter.sendMail({
			...
			<div variant="body1" style="color: gray; letter-spacing: 2px; text-align: center;  margin: 10px auto;">For More Query, You can reach us at 9810024561, Thank You for choosing MWH</div>
			</div>
		  </div>`,
		});
